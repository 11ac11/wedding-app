...
export default async function Travel() {
  return (
    <main>
      <HideImage src={Tenerife} alt="Tenerife" fill={true} />
      ...
      <div className="info-section">
        ...
        <p>{`Both Barcelona and Castelldefels are in zone 1.`}</p>
        ...
        <ul>
          ...
          <li>{`From: Estacio de Francia, Passeig de Gracia or Barcelona Sants`}</li>
        </ul>
      ...
      <div className="info-section">
        ...
        <p>{`A taxi from the airport costs around 20-30€ each way.`}</p>
      </div>
    </main>
  )
}
