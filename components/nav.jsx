...
export default function Nav({ openClose, className }) {
  return (
    <NavContainer className={className}>
      <Navigation>
        <Link href="/" onClick={() => openClose()}>
          Home
        </Link>
        <Link href="/rsvp" onClick={() => openClose()}>
          RSVP
        </Link>
        <Link href="/itinerary" onClick={() => openClose()}>
          Itinerary
        </Link>
        <Link href="/travel" onClick={() => openClose()}>
          Travel
        </Link>
        <Link href="/accommodation" onClick={() => openClose()}>
          Accommodation
        </Link>
        <Link href="/gifts" onClick={() => openClose()}>
          Gifts
        </Link>
        <Link href="/faqs" onClick={() => openClose()}>
          FAQs
        </Link>
      </Navigation>
    </NavContainer>
